    ...
    <div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a href="#" class="btn" :class="isLikeClass" @click="toggleLike">good~</a>
...
<script setup>
/*
script setup 을 사용하는 컴포넌트는 기본적으로 Template Refs나 $parent 와 같이 컴포넌트간 통신에 닫혀있다.
내부에 사용된 데이터나 메소드를 명시적으로 노출하려면 defineExpose() 컴파일러 매크로를 사용할 수 있다.
*/
